...
public class UnixiNSEpochParser implements TimestampParser {
    private static long MAX_EPOCH_MILLISECONDS = (long) Integer.MAX_VALUE * 1000 * 1000;

    @Override
    public Instant parse(String value) {
        return parse(Long.parseLong(value) / 1000);
    }
    ...
    public Instant parse(Double value) {
        ...
        return parse(value.longValue() / 1000);
    }
